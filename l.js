        ...
        var checkLoaded = scriptTag.src.match(/checkLoaded/) ? 1 : 0
            ...
            , loader = {
                ...
                , loadjs: function (url, cb) {
                    ...
                    appendElmt(scriptStr, {
                        type: typeJS, src: url, id: parts.i, onerror: function (error) {
                            onError(url);
                            var c = error.currentTarget;
                            c.parentNode.removeChild(c);
                            appendElmt(scriptStr, {
                                type: typeJS, src: parts.f, id: parts.i, onerror: function () {
                                    onError(parts.f)
                                }
                            }, cb);
                        }
                ...
                , load: function () {
                    ...
                    load(loader, argv[0], argc <= 1 ? undefined : function () {
